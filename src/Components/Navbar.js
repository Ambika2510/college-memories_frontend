...
<form className="relative w-full hidden lg:block " onSubmit={handlesearchuser}>    
    ...
    <button data-collapse-toggle="navbar-search" type="button" className="absolute right-0 top-0 inline-flex items-center p-2 text-lg text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded="false">
